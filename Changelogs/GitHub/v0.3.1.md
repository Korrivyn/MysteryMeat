...
## Highlights
- BUGFIX: Incremented game version to Fully Loaded 1.2.7+ as mentioned in the v0.3.0 changelog.
- BUGFIX: Alerted diners now stay with their group, follow the vanilla escape flow, and activate game-end on escape.
