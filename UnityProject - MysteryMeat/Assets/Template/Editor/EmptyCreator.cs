...
namespace EmptyAtZeroCreator
{
    ...
    public class EmptyCreator
    {
        ...
        private static class EditorDebugLogBridge
        {
            ...
            /// <summary>
            /// Locates the runtime debug logging type so editor tools can forward verbose output.
            /// </summary>
            /// <returns>The logging type when found within the current application domain.</returns>
            ...
            /// <summary>
            /// Fetches the verbose logging method exposed by the runtime logging helper.
            /// </summary>
            /// <returns>The resolved verbose logging method, or null if unavailable.</returns>
            ...
            /// <summary>
            /// Emits a verbose log using the runtime logging bridge when possible.
            /// </summary>
            /// <param name="message">The diagnostic message to forward.</param>
